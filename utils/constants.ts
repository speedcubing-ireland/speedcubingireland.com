...
export const IRISH_COMPS_URL = `${WCA_URL}/competitions?region=Ireland&search=&state=present&year=all+years&from_date=&to_date=&delegate=&show_registration_status=on&display=list`;
