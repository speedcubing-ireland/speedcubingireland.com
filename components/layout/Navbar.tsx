...
import {
  faAward, faBars, faBolt, faCircleInfo, faCircleQuestion, faEnvelope, faHome, faMoon, faSun,
...
function Navbar() {
  ...
  const themeButton = (classes: string) => {
    ...
    const handleThemeChange = () => setTheme(isDark ? 'speedcubing' : 'speedcubing-dark');
